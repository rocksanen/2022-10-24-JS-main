...
let convertableValue = "1999"
convertableValue = 1999

console.log(convertableValue);
...
function hungryDog(pounds,age){
  ...
  if(age < 1) {
   ...
   if(age > 7/12) {
    ...
    amountOfFood = pounds * 0.04
    
   }else if(age >= 4/12 && age < 7/12 ) {

    amountOfFood = pounds * 0.05
    
   }else if(age >= 2/12 && age < 4/12){

    amountOfFood = pounds * 0.1
    ...
    if(pounds > 15){
      ...
      amountOfFood = pounds * 0.02

    }else if(pounds >= 11 && pounds <= 15){

      amountOfFood = pounds * 0.03
...
let computerChoise = Math.random %3
...
console.log(game("scissors", computerChoise));
...
function vowelCounter(word) {
  ...
  const count = word.toLowerCase().match(/[aeiouyäö]/gi).length  // Suomen vokaalit
  return count

}

console.log(vowelCounter("otto"))
